...
type RegistRequest struct {
	...
	WorkerGrpcAddr string                 `protobuf:"bytes,3,opt,name=worker_grpc_addr,json=workerGrpcAddr,proto3" json:"worker_grpc_addr,omitempty"` // worker 侧 Controller2Worker gRPC 服务的监听地址
...
func (x *RegistRequest) GetWorkerGrpcAddr() string {
	if x != nil {
...
type WorkerInfo struct {
	...
	// GPU / VPU / NPU（预留，用于异构设备能力建模）
	GpuName         string `protobuf:"bytes,12,opt,name=gpu_name,json=gpuName,proto3" json:"gpu_name,omitempty"`                          // GPU 型号名称，无 GPU 则为空
	GpuMemory       uint64 `protobuf:"varint,13,opt,name=gpu_memory,json=gpuMemory,proto3" json:"gpu_memory,omitempty"`                   // GPU 显存（bytes），无 GPU 则为 0
	HardwareEncoder bool   `protobuf:"varint,14,opt,name=hardware_encoder,json=hardwareEncoder,proto3" json:"hardware_encoder,omitempty"` // 是否支持硬件编码器（如 NVENC / VideoToolbox / VAAPI）
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WorkerInfo) GetGpuMemory() uint64 {
	if x != nil {
		return x.GpuMemory
	}
	return 0
...
func (x *WorkerInfo) GetHardwareEncoder() bool {
	if x != nil {
...
const file_worker_proto_rawDesc = "" +
	"\n" +
	"\fworker.proto\x12\x1bworker_2_controller_service\"\x86\x01\n" +
	"\rRegistRequest\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\tR\x02ip\x12;\n" +
	"\x04info\x18\x02 \x01(\v2'.worker_2_controller_service.WorkerInfoR\x04info\x12(\n" +
	"\x10worker_grpc_addr\x18\x03 \x01(\tR\x0eworkerGrpcAddr\"\xc2\x03\n" +
	"\n" +
	"WorkerInfo\x12\x1a\n" +
	...
	"\fmemory_total\x18\v \x01(\x04R\vmemoryTotal\x12\x19\n" +
	"\bgpu_name\x18\f \x01(\tR\agpuName\x12\x1d\n" +
	"\n" +
	"gpu_memory\x18\r \x01(\x04R\tgpuMemory\x12)\n" +
	"\x10hardware_encoder\x18\x0e \x01(\bR\x0fhardwareEncoder\"B\n" +

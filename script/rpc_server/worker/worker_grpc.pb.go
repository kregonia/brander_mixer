...
func (UnimplementedWorker2ControllerServer) RegistWorker(context.Context, *RegistRequest) (*RegistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegistWorker not implemented")
}
func (UnimplementedWorker2ControllerServer) Hearting(context.Context, *HeartingRequest) (*HeartingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Hearting not implemented")
}
...
func RegisterWorker2ControllerServer(s grpc.ServiceRegistrar, srv Worker2ControllerServer) {
	// If the following call panics, it indicates UnimplementedWorker2ControllerServer was
